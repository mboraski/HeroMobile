...
import { fishOrdersRequest } from '../actions/orderActions';
...
class DeliveryStatusScreen extends Component {
    ...
    renderOrderRequests = () => {
        const { potentialOrders, state } = this.props;
        let result;
    ...
    render() {
        const { pending, potentialOrders, currentOrder } = this.props;
        return (
            <View style={styles.container}>
                {!potentialOrders || !currentOrder ? (
                    <View style={styles.container}>
                        <Text style={styles.searching}>
                            Scanning the sky for beacons...
                        </Text>

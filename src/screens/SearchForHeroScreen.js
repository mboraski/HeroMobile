    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                />
                {true && <Text style={styles.loadingText}>Loading...</Text>}
                ...
                <View style={styles.heroItem}>
                    ...
                    <Text style={styles.fillOrder}>
                        Fullfills partial order
                    </Text>
                    <Text style={styles.deliveryTime}>
                        Estimated Delivery Time: 9 min
                    </Text>
                    <Icon name="chat" size={30} color={'#555555'} />
                </View>
            </View>
